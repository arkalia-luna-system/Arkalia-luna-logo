...
Génère toutes les déclinaisons dimensionnelles (Square 1:1, Landscape 16:9, Portrait 9:16)
...
def generate_square_1_1(source_svg: Path, output_dir: Path, sizes: list[int] = [256, 512, 1024]):
    """
